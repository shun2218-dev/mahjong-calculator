  ...
  describe("緑一色を正しく判定できる", () => {
      it('⭕️ 成立：緑一色 の場合 (發あり、ソーズのみ)', () => {
        const dummyHand = createDummyHand({
            tehai: ['2s', '2s', '2s', '3s', '4s', '6s', '6s', '6s', '8s', '8s', 'hatsu', 'hatsu', 'hatsu', '4s']
        });
      ...
      it('⭕️ 成立：緑一色 の場合 (發なし、ソーズのみ)', () => {
        const dummyHand = createDummyHand({
            tehai: ['2s', '2s', '2s', '3s', '4s', '6s', '6s', '6s', '8s', '8s', '8s', '4s', '3s', '4s']
        });
      ...
      it('❌ 不成立：緑以外のソーズ (5s) が混ざっている場合', () => {
        const dummyHand = createDummyHand({
            tehai: ['2s', '2s', '2s', '3s', '4s', '5s', '6s', '6s', '8s', '8s', 'hatsu', 'hatsu', 'hatsu', '4s']
        });
      ...
      it('❌ 不成立：他の色 (1m) が混ざっている場合', () => {
        const dummyHand = createDummyHand({
            tehai: ['1m', '2s', '2s', '3s', '4s', '6s', '6s', '8s', '8s', 'hatsu', 'hatsu', 'hatsu', '4s', '3s']
        });

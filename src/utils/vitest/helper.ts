...
export const createDummyParsedHand = (
	overrides: Partial<ParsedHand> = {},
): ParsedHand => {
...
export const createDummyHand = (
	overrides: Partial<Omit<CalculateRequestDto, "status">> = {},
	overridesStatus: Partial<CalculateRequestDto["status"]> = {},
): Hand => {
...
export const createDummyYakuResult = (
	yakuList: Yaku[],
	doraHan: number = 0,
): YakuResult => {

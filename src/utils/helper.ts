import { CHUNCHANPAI_SET, JIHAI_SET, KAZEHAI_SET, ROUTOUHAI_SET, YAOCHUHAI_SET } from "@/const/TILE_TYPE";
...
export function isKoutsuOf(mentsu: Mentsu, tile: Tile): boolean {
    return (mentsu.type === "koutsu" || mentsu.type === "kantsu") && mentsu.tiles[0] === tile;
}

...
describe("Hand", () => {
    ...
    it("isTsumoが正しく判定できるか", () => {      
        ...
        const dummyHandRon = new Hand({
            tehai: ["1m", "1m", "1m", "2m", "3m", "4m", "5m", "6m", "7m", "8m", "8m", "8m", "9m"],
            fuuro: [],
            agariHai: "9m",
            agariType: "ron",
            status: {
    ...
    it("isRinshanが正しく判定できるか", () => {      
        const dummyHandRinshan = new Hand({
            tehai: ["1m", "1m", "1m", "1m", "2m", "3m", "4m", "5m", "6m", "7m", "8m", "8m", "8m", "9m", "9m"],
    ...
    it("allTilesが正しく取得できるか", () => {      
        ...
        expect(dummyHandTsumo.allTiles).toEqual(["1m", "1m", "1m", "2m", "3m", "4m", "5m", "6m", "7m", "8m", "8m", "8m", "9m", "9m"]);


        const dummyHandRon = new Hand({
            tehai: ["1s", "1s", "1s", "2m", "3m", "4m", "5m", "6m", "7m", "8m", "8m", "8m", "9m"],
            fuuro: [],
            agariHai: "9m",
            agariType: "ron",
            status: {
        ...
        expect(dummyHandRon.allTiles).toEqual(["1s", "1s", "1s", "2m", "3m", "4m", "5m", "6m", "7m", "8m", "8m", "8m", "9m", "9m"]);
        ...
        expect(dummyHandNaki.allTiles).toEqual(["1s", "1s", "1s", "3m", "3m", "3m", "4m", "4m", "4m", "8m", "8m", "8m", "9m", "9m"]);
    });

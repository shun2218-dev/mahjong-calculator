...
export class PointCalculator {
    ...
    private calculatePayment(kihonten: number, hand: Hand, name: string, yakuList: Yaku[]): PointResult {
        if (hand.isOya) {
            if (hand.isTsumo) {
        ...
        if (hand.isTsumo) {
            ...
            return { total: oyaPayment + koPayment * 2, oya: oyaPayment, ko: koPayment, name, yakuList };
        }

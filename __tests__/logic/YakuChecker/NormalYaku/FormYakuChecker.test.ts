    ...
    describe("形による役を正しく判定できる", () => {
        describe("checkTanyao：断么九 を正しく判定できる", () => {
            it("⭕️ 成立：么九牌 が1つもない場合", () => {            
                const dummyHand = createDummyHand({
                    tehai: ["2m", "3m", "4m", "5p", "5p", "6s", "7s", "8s", "2p", "3p", "4p"],
            ...
            it("❌ 不成立：1が含まれている場合", () => {
                const dummyHand = createDummyHand({
                    tehai: ["1m", "2m", "3m", "5p", "5p", "6s", "7s", "8s", "2p", "3p", "4p"],
                    fuuro: [{ type: "pon", tiles: ["5s", "5s", "5s"] }],
                    agariHai: "4p",
                    agariType: "ron"
                });
            ...
            it("❌ 不成立：9が含まれている場合", () => {
                const dummyHand = createDummyHand({
                    tehai: ["2m", "3m", "4m", "5p", "5p", "7s", "8s", "9s", "2p", "3p", "4p"],
                    fuuro: [{ type: "pon", tiles: ["5s", "5s", "5s"] }],
                    agariHai: "4p",
                    agariType: "ron"
                });
            ...
            it("❌ 不成立：字牌が含まれている場合", () => {
                const dummyHand = createDummyHand({
                    tehai: ["1m", "2m", "3m", "6s", "7s", "8s", "2p", "3p", "4p", "haku", "haku"],
                    fuuro: [{ type: "pon", tiles: ["5s", "5s", "5s"] }],
                    agariHai: "4p",
                    agariType: "ron"
                });
        ...
        describe("checkShousangen：小三元 を正しく判定できる", () => {
            it("⭕️ 成立：雀頭が三元牌かつ三元牌の刻子が2つの場合", () => {
                ...
                const dummyParsedHand = createDummyParsedHand({ mentsuList, janto: ["hatsu", "hatsu"] });
            ...
            it("❌ 不成立：雀頭が三元牌ではない場合", () => {
                ...
                const dummyParsedHand = createDummyParsedHand({ mentsuList, janto: ["1p", "1p"] });
